...
function AProgSec() {
  ...
  // 6. GET FILTERED SECTIONS USING PER-PROGRAM FILTERS
  const getFilteredSections = (programId) => {
    const programSections = sections[programId] || [];
    const progFilters = sectionFilters[programId] || { yearLevel: "", semester: "" };
    ...
    return programSections.filter(section => {
      ...
      const matchesYearLevel = !progFilters.yearLevel || section.year_level?.toString() === progFilters.yearLevel;
      const matchesSemester = !progFilters.semester || section.semester_label === progFilters.semester;
    ...
    <div className="CardsContainer">
      {loading ? (
        ...
        filteredPrograms.map((prog) => {
          ...
          const currentFilters = sectionFilters[prog.program_id] || { yearLevel: "", semester: "" };
                  ...
                  <div className="CardExpandedControls">
                    ...
                    <div className="CardExpandedBtnGroup">
                      ...
                      >
                        ...
                        {/* RENDER FILTER POPUP ONLY FOR ACTIVE PROGRAM */}
                          ...
                          <div className="FilterDropdown">
                            <div className="FilterGroup">
                              ...
                              <select 
                                ...
                                onChange={(e) => updateSectionFilter(prog.program_id, 'yearLevel', e.target.value)}
                              >
                            ...
                            <div className="FilterGroup">
                              ...
                              <select 
                                ...
                                onChange={(e) => updateSectionFilter(prog.program_id, 'semester', e.target.value)}
                              >
                            ...
                            <div className="BtnsContainer">
                              <button className="ResetFilterBtn" onClick={() => resetFilters(prog.program_id)}>Reset</button>
                              <button className="ApplyFilterBtn" onClick={() => setOpenFilterProgramId(null)}>Apply</button>
                            </div>
                          </div>
                        )}
                      </div>
